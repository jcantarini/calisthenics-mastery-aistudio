-- Sprint 8.1A2 — disposable-environment bootstrap for the auxiliary suite.
-- NOT A MIGRATION. Never applied to preview/production.
--
-- Provides the minimal Supabase-like surface the 19 project migrations need:
--   * roles: anon, authenticated, service_role
--   * schema auth with auth.users and auth.uid()
-- and the harness used by the auxiliary regression suite. It is an
