...
| Document                                                                                 | Content                                                                                                                                                                                             |
| ---------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| [../ROADMAP.md](../ROADMAP.md)                                                           | Complete roadmap and platform acceptance gates                                                                                                                                                      |
| [ai-studio-migration-audit.md](./ai-studio-migration-audit.md)                           | Migration recovery, portable baseline and validation                                                                                                                                                |
...
| [decisions/0005-progress-history-domain.md](./decisions/0005-progress-history-domain.md) | ADR 0005 — Progress History domain, **Accepted** in Sprint 8.0B-B2B; extends Core Architecture v1.0; partially implemented — core history schema (8.1A1) and auxiliary facts schema (8.1A2)         |
| [progress-history-domain-contracts.md](./progress-history-domain-contracts.md)           | Ratified normative contract companion to Accepted ADR 0005; core tables (8.1A1) and auxiliary fact tables (8.1A2) with constraints, indexes, RLS and grants; trusted completion not yet operational |
| [progress-history-core-validation.md](./progress-history-core-validation.md)             | Sprint 8.1A1 core schema validation record; `8.1A1-V2 — INDEPENDENTLY VALIDATED`                                                                                                                    |
| [progress-history-auxiliary-validation.md](./progress-history-auxiliary-validation.md)   | Sprint 8.1A2 auxiliary facts schema and validation record; `8.1A2 — INDEPENDENTLY VALIDATED`                                                                                                        |
| [progress-history-outbox-validation.md](./progress-history-outbox-validation.md)         | Sprints 8.1A3 and 8.1A3-C1 durable dispatch outbox schema, privilege reset, security and validation record; `8.1A3-C1 — IMPLEMENTED, PENDING INDEPENDENT VALIDATION`                                |
