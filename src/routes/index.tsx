    ...
    <div className="px-5 pt-12">
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-2xl font-bold leading-none">
                {state.streak} <span className="text-sm font-normal text-muted-foreground">dias</span>
              </p>
            </div>
          </div>
      ...
      <section className="mt-6">
        <div className="flex items-baseline justify-between">
          <h2 className="text-display text-2xl">Treino de hoje</h2>
          ...
          <div className="flex items-start justify-between">
            <div className="min-w-0 flex-1">
              ...
              <div className="mt-4 flex flex-wrap gap-2">
                ...
                <span className="rounded-full border border-border/60 bg-background/40 px-3 py-1 text-[11px] font-medium">
                  {active.exercises.length} exercícios
                </span>
              </div>
            </div>
            <button
      ...
      <section className="mt-8">
        <div className="flex items-baseline justify-between">
          <h2 className="text-display text-2xl">Programas</h2>
              ...
              >
                ...
                <div className="min-w-0 flex-1">
                  ...
                  <p className="truncate text-xs text-muted-foreground">
                    {p.weeks} sem · {p.daysPerWeek}×/sem · {p.duration}
                  </p>
                </div>
      ...
      <section className="mt-8 rounded-3xl border border-accent/30 bg-accent/5 p-5">
        <div className="flex items-center gap-2 text-accent">
          ...
          <p className="text-[11px] font-semibold uppercase tracking-widest">Dica do dia</p>
        </div>
        <p className="mt-2 text-sm leading-relaxed">
          Escápulas <span className="font-bold text-foreground">retraídas e deprimidas</span> antes
          de puxar a barra. Isso ativa os dorsais e protege os ombros.
        </p>
      </section>
    </div>
  );
